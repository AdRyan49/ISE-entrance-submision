...
void handleJS() {
  ...
  js += "document.getElementById('alert1').textContent = parseFloat(data.air1) > 150 ? ' Poor Air Quality!' : '';";
  js += "document.getElementById('alert2').textContent = parseFloat(data.air2) > 150 ? 'Poor Air Quality!' : '';";
